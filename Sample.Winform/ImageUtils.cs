...
namespace Sample.Winform
{
        ...
        {
           public float blankThreshold { get; set; } = 60f;
        ...
        public ImageProcessor() : this(false)
            ...
            /// <summary>Constructor</summary>
            /// <param name="useUnsafeCode">True to use unsafe (faster code)</param>
            public ImageProcessor(bool useUnsafeCode,float blankThreshold=60f)
            {
        ...
        public bool IsBlank(Image stream)
        {
            // TODO: Download more images and put in two folders... calculate stats
            double stdDev = useUnsafeCode ? StdDevUnsafe(stream) : StdDev(stream);
        ...
        public double StdDev(Image stream)
        {
        ...
        public double StdDevUnsafe(Image stream)
        {
            double total = 0, totalVariance = 0;
            int count = 0;
            double stdDev = 0;
